  ...
  return <header className="fixed z-50 w-screen p-6 px-16 ">
    ...
    <div className="hidden md:flex w-full h-full ">
      ...
      <ul className="flex items-center gap-x-8 ml-auto">
        <li className="text-base text-textColor cur">Home</li>
        <li className="text-base text-textColor cur">Menu</li>
        <li className="text-base text-textColor cur">About Us</li>
        <li className="text-base text-textColor cur">Services</li>
      </ul>
    </div>
